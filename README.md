...
## Best Practices 
  ...
  **2. Too high (e.g., 99) may miss fraudulent ones.Monitor Flagged Orders** 
...
# Other solution25 Plugins
Here are other plugins developed by solution25 that might be useful alongside the MaxMind fraud detection plugin in a Shopware store:

**NMI**: Integrates the NMI payment gateway for secure transactions. [GitHub Repo](https://github.com/solution25com/nmi-payment-shopware-6-solution25)
**BlueSnap**:Supports global payments with multiple currencies. [GitHub Repo](https://github.com/solution25com/bluesnap-payment-shopware-6-solution25)
**Paytrace**:A secure payment processor for smooth transactions. [GitHub Repo](https://github.com/solution25com/paytrace-payment-shopware-6-solution25)
**Listrak**:A marketing automation tool for email and SMS. [Coming Soon]()
**Store Credit**: Allows customers to use store credit. [Coming Soon]()
**Abandoned Cart Saver**:Helps recover lost sales with automated cart reminders. [Coming Soon]()
**CyberSource Integration**:Secure payment processing and fraud detection. [GitHub Repo](https://github.com/solution25com/cybersource-payment-shopware-6-solution25)
**Optimizely Campaign for Shopware 5 & 6**: Integration with Optimizely for effective marketing campaigns. [GitHub Repo for Shopware 5](https://github.com/solution25com/optimizely-campaign-shopware-5-solution25), [GitHub Repo for Shopware 6](https://github.com/solution25com/optimizely-campaign-shopware-6-solution25)
